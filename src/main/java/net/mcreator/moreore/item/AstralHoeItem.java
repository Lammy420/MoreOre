...
public class AstralHoeItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:astral_hoe")
	public static final Item block = null;
	public AstralHoeItem(MoreOreModElements instance) {
		super(instance, 58);
	}
