...
public class AuricOreItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:auric_ore")
	public static final Item block = null;
	public AuricOreItem(MoreOreModElements instance) {
		super(instance, 95);
	}
