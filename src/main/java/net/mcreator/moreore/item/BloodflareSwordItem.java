...
public class BloodflareSwordItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:bloodflare_sword")
	public static final Item block = null;
	public BloodflareSwordItem(MoreOreModElements instance) {
		super(instance, 46);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("bloodflare_sword"));
	}
}
