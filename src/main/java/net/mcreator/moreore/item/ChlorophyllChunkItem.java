...
public class ChlorophyllChunkItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:chlorophyll_chunk")
	public static final Item block = null;
	public ChlorophyllChunkItem(MoreOreModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("chlorophyll_chunk");
		}
