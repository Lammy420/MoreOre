...
public class AstralShovelItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:astral_shovel")
	public static final Item block = null;
	public AstralShovelItem(MoreOreModElements instance) {
		super(instance, 57);
	}
