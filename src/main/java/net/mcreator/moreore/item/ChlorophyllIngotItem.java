...
public class ChlorophyllIngotItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:chlorophyll_ingot")
	public static final Item block = null;
	public ChlorophyllIngotItem(MoreOreModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("chlorophyll_ingot");
		}
