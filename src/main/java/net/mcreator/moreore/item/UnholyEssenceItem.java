...
public class UnholyEssenceItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:unholy_essence")
	public static final Item block = null;
	public UnholyEssenceItem(MoreOreModElements instance) {
		super(instance, 93);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("unholy_essence");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The essence of profaned creatures"));
		}
	}
}
