...
public class CoreOfCalamityItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:core_of_calamity")
	public static final Item block = null;
	public CoreOfCalamityItem(MoreOreModElements instance) {
		super(instance, 96);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("core_of_calamity");
		}
