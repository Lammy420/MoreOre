...
public class BloodflareNuggetItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:bloodflare_nugget")
	public static final Item block = null;
	public BloodflareNuggetItem(MoreOreModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bloodflare_nugget");
		}
