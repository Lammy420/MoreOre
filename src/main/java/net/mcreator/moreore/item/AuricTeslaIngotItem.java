...
public class AuricTeslaIngotItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:auric_tesla_ingot")
	public static final Item block = null;
	public AuricTeslaIngotItem(MoreOreModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("auric_tesla_ingot");
		}
