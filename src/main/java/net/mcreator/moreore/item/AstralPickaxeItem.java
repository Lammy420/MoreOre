...
public class AstralPickaxeItem extends MoreOreModElements.ModElement {
	@ObjectHolder("more_ore:astral_pickaxe")
	public static final Item block = null;
	public AstralPickaxeItem(MoreOreModElements instance) {
		super(instance, 54);
	}
